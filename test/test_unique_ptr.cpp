...
int main() {
    ...
    {
        auto p0 = make_unique_ptr<int, short, 3>(42);
        BOOST_TEST_EQ(sizeof(p0), sizeof(short));
        BOOST_TEST_EQ(*p0, 42);

        auto p1 = make_unique_ptr<int, short, 3>(43);
        BOOST_TEST_EQ(*p0, 42);
        BOOST_TEST_EQ(*p1, 43);

        auto p2 = make_unique_ptr<int, short, 3>(44);
        BOOST_TEST_EQ(*p0, 42);
        BOOST_TEST_EQ(*p1, 43);
        BOOST_TEST_EQ(*p2, 44);

        BOOST_TEST_THROWS((make_unique_ptr<int, short, 3>(45)), std::bad_alloc);
    }

    {
        auto p0 = make_unique_ptr<test_type, short, 3>(42);
        BOOST_TEST_EQ(*p0, 42);

        auto p1 = make_unique_ptr<test_type, short, 3>(43);
        BOOST_TEST_EQ(*p0, 42);
        BOOST_TEST_EQ(*p1, 43);

        auto p2 = make_unique_ptr<test_type, short, 3>(44);
        BOOST_TEST_EQ(*p0, 42);
        BOOST_TEST_EQ(*p1, 43);
        BOOST_TEST_EQ(*p2, 44);

        p0.reset();
        p0 = make_unique_ptr<test_type, short, 3>(45);
        BOOST_TEST_EQ(*p0, 45);
        BOOST_TEST_EQ(*p1, 43);
        BOOST_TEST_EQ(*p2, 44);
        ...
        p0.reset(make_unique_ptr<test_type, short, 3>(46));
        BOOST_TEST_EQ(*p0, 46);
        BOOST_TEST_EQ(*p1, 43);
        BOOST_TEST_EQ(*p2, 44);
    }
